...
public class E_02_Control : EnemyControl
{
    // Start is called before the first frame update
    public E_02_DataBiding dataBiding;
    public E_02_FSM_IdleState idleState;
    public E_02_FSM_AttackState attackState;
    public E_02_FSM_DeadState deadState;
    public E_02_FSM_HitState hitState;
    public E_02_FSM_MoveState moveState;
