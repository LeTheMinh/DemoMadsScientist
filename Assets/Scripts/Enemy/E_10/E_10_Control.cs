...
public class E_10_Control : EnemyControl
{
    public E_10_DataBiding dataBiding;
    // state 
    public E_10_FSM_IdleState idleState;
    public E_10_FSM_AttackState attackState;
    public E_10_FSM_DeadState deadState;
    public E_10_FSM_HitState hitState;
    public E_10_FSM_MoveState moveState;
