...
public class E_05_Control : EnemyControl
{
    public E_05_DataBiding dataBiding;
    // state 
    public E_05_FSM_IdleState idleState;
    public E_05_FSM_AttackState attackState;
    public E_05_FSM_DeadState deadState;
    public E_05_FSM_HitState hitState;
    public E_05_FSM_MoveState moveState;
